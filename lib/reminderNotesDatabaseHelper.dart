...
class ReminderNotesDb {
  static final _databasename="MyReminder.db";
  static final _databaseVersion=1;
  static final table='my_reminder';
  ...
  ReminderNotesDb._privateConstructor();
  static final ReminderNotesDb instance=ReminderNotesDb._privateConstructor();
